...
def show_page():
    ...
    st.markdown('CosmΩracle is an app that calculates distances in cosmology. If you wish to compute the values of cosmologically relevant distances - choose the "Cosmological distances" option in the sidebar, fill the values of cosmological parameters and press enter. Note that the default cosmology is already set.')
