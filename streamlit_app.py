...
with logo:
    image = 'https://github.com/nikosarcevic/CosmOracle/blob/main/images/logowname_old.png?raw=true'
...
if z_value:
    ...
    if plot_rz or plot_trz or plot_DLz or plot_DAz:
        ...
        ps.plot_distances(plot_rz, plot_trz, plot_DLz, plot_DAz, z_array, rz_array, trz_array, DLz_array, DAz_array)
