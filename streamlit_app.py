...
if not z_value:
    ...
    st.markdown('CosmΩracle will also plot those distances as a function of redshift. In cse you want to plot it yourself - you can easily download the data in a .txt format.')
